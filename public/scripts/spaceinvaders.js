...
PlayState.prototype.update = function(game, dt) {
	...
	//  Move each rocket.
	for (i = 0; i < this.rockets.length; i += 1) {
	...
	for (var i = 0; i < this.config.invaderFiles; i += 1) {
...
PlayState.prototype.draw = function(game, dt, ctx) {
	...
	//  Draw invaders.
	// var mySprite = loadSprite("assets/invader.png");
	// var w = 14;
	// var h = 18;
	ctx.fillStyle = '#006600';
	// ctx.drawImage(mySprite, 0, 0, w, h, -w/2, -h/2, w, h);
